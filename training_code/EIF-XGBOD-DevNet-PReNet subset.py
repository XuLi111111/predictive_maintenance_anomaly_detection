...
idx_sample = rng.choice(len(X_train), size=10000, replace=False)
X_train_xgbod = X_train[idx_sample]
y_train_xgbod_sub = y_train_xgbod[idx_sample]

xgbod = XGBOD(random_state=42)
xgbod.fit(X_train_xgbod, y_train_xgbod_sub)
